        ...
        <div className='flex items-center justify-center h-screen w-screen'>
          <div className='flex flex-col items-center justify-center'>
            ...
            {/* <div className='hidden sm:block flex flex-col space-y-4 items-center justify-center sm:space-y-0 sm:flex-row sm:space-x-8 mt-6'>
              {pages.map(page => <button className='transition rounded hover:bg-slate-200 active:bg-slate-300 px-2 pt-1 pb-0 tracking-widest uppercase font-josefin font-semibold' key={page.title}>{page.title}</button>)}
            </div> */}
            <div className='flex items-center space-x-0 sm:space-x-4 mt-6'>
              <IconContext.Provider value={{ className: "w-10 h-10 sm:h-12 sm:w-12 p-2 transition duration-100 hover:scale-125 cursor-pointer active:scale-100" }}>
                ...
                <ExternalLink href="https://www.soundcloud.com/airshyre"><ImSoundcloud2 className='w-9 h-9 sm:w-11 sm:h-11 hover:text-orange-600 active:text-orange-700'/></ExternalLink>
